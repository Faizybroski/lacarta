        ...
        <div className="container">
          <div className="row bg-white py-4 px-3 shadow rounded">
            ...
            <div className="col-md-7">
              <h2 className="fonted-title text-black fw-bold">
              ...
              <button className="btn text-light bg-gradient-to-r from-[#E6B65C] via-[#D4A74A] to-[#B8902F] hover:brightness-110 btn-md w-100">
                BOOK TRIP
              </button>
            </div>
      ...
      <div className="container-fluid p-0 d-block d-md-none">
        ...
        <div className="container mt-3">
          <div className="bg-white text-center p-3">
            ...
            <button className="btn c2 text-light btn-md w-100">
              BOOK TRIP
            </button>
          </div>
        </div>
