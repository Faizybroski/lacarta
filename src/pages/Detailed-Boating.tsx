...
import { boatingData } from "@/data/detailed-boating.data";
...
export default function DetailedBoating() {
  ...
  return (
    ...
    <div className="bg-[#f7f7f7] px-1 py-3 md:py-5 md:px-5">
      ...
      <PlayaScondidaCard />
      <PaginationListing {...boatingData}></PaginationListing>
      <PlayaScondidaAbout />
      <HomeArea />
      <KeyFeatures />
      <ServicesAmenities />
      <ContactBooking />
      <AroundThisPlace  {...boatingData}/>
      </div></div>
      <FaqSection />
      <CartagenaNews />
  </>
